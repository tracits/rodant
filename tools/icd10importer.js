...
if (!inputPath || !outputPath) {
	console.log("Usage: node icd10importer.js <input filename> <optional: output filename, default: ../src/data/icd10.json>")
	process.exit(1)
}

var data = fs.readFileSync(inputPath).toString().split('\n')
